...
def taxiJFKTest():
	...
	count=0
	f1 = open('./data/financialpickups_'+month+'.csv','w')
	f2 = open('./data/nyupickups_'+month+'.csv','w')
	f3 = open('./data/timesquarepickups_'+month+'.csv','w')
	f4 = open('./data/brooklynpickups_'+month+'.csv','w')
	f5 = open('./data/financialdropoffs_'+month+'.csv','w')
	f6 = open('./data/nyudropoffs_'+month+'.csv','w')
	f7 = open('./data/timesquaredropoffs_'+month+'.csv','w')
	f8 = open('./data/brooklyndropoffs_'+month+'.csv','w')
	...
	with open('yellow_tripdata_2015-01.csv', 'rb') as csvfile:
		...
		for row in spamreader:
			if(skip<1):
				...
				f5.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n")
				f6.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n")
				f7.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n")
				f8.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n")
				skip = skip+1
				continue
			lat=float(row[6])
			lon=float(row[5])
			...
			if financial.contains(pt) :
				...
				count=count+1
				f4.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n") 
			if financial.contains(pt1) :
				count=count+1
				f5.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n")
			elif nyu.contains(pt1):
				count=count+1
				f6.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n")
			elif timesquare.contains(pt1):
				count=count+1
				f7.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n") 
			elif brooklyn.contains(pt1):
				count=count+1
				f8.write(row[0]+","+row[1]+","+row[2]+","+row[3]+","+row[4]+","+row[5]+","+row[6]+","+row[7]+","+row[8]+","+row[9]+","+row[10]+","+row[11]+","+row[12]+","+row[13]+","+row[14]+","+row[15]+","+row[16]+","+row[17]+","+row[18]+"\n") 
